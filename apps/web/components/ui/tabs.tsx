...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-start gap-1 overflow-x-auto rounded-lg bg-muted/60 p-1 text-muted-foreground no-scrollbar",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-4 focus-visible:outline-none animate-in fade-in-0 slide-in-from-bottom-1 duration-300",
      className,
    )}
    {...props}
  />
